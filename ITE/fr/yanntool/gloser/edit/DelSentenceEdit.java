...
/** Action reversible: Supression d'une phrase.
*/
public class DelSentenceEdit extends AbstractUndoableEdit {

		private org.jdom.Element element_;
		private int index_;
		private frame_editor model_;

	public DelSentenceEdit(frame_editor model, org.jdom.Element element, int index) {
		model_   = model;
		element_ = element;
		index_   = index;

...
/** Action reversible: Suppression d'un mot.
*/
public class DelWordEdit extends AbstractUndoableEdit {

		private org.jdom.Element element_;
		private int              index_, sentenceNum_;
		private frame_editor        model_;

	public DelWordEdit(frame_editor model, org.jdom.Element element, int index, int sentenceNum) {
		model_       = model;
		element_     = element;
		index_       = index;

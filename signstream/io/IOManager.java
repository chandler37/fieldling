...
/* public abstract TranscriptionMetaData loadTransMetaData (int transID);
  public abstract int storeTranscription (Transcription trans);
  public abstract Transcription loadTranscription (int transID);
  public abstract Transcription loadTranscription (TranscriptionMetaData metaData);
  public abstract boolean supportsSearches ();

...
/*
 * SequencerModelListener.java
 *
 * Created on January 14, 2003, 3:10 PM
 */
...
public interface SequencerModelListener extends EventListener {

  void trackAdded(SequencerTrack track);
  void trackRemoved(SequencerTrack track);
  // void trackUpdated(SequencerTrack track);
  void tracksReordered();
  
  void trackUpdated(SequencerTrack track);
  
  //void trackItemAdded(TrackItem item);
  //void trackItemRevoved(TrackItem item);
  //void trackItemUpdated(TrackItem oldItem, TrackItem newItem);
  // void trackItemsAdded(List items);
  // void trackItemsRemoved(List items);
  // void trackItemTimeChanged(SequencerTrack track, TrackItem item);
}

...
public final class SchemeConstant {
  private SchemeConstant() {}
  
  public static final String    INTERNAL_PROPERTY_TAG = "_";

  public static final String    DIFF          = INTERNAL_PROPERTY_TAG+"diff";
  public static final String    DIFF_MISSING  = "missing";
  public static final String    DIFF_NEW      = "new";
  public static final String    DIFF_CHANGED  = "changed";
  public static final String    DIFF_COPIED   = "copied";
  
  public static final String    SOURCE        = "source";
  public static final String    IMPORT_DATE   = "import-date";

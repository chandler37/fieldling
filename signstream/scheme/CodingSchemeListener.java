...
/*
 * CodingSchemeListener.java
 *
 * Created on August 2, 2002, 1:07 PM
 */
...
public interface CodingSchemeListener extends PropertyChangeListener {

  // FROM PropertyChangeListener:
  // public void propertyChange(PropertyChangeEvent event);
  
  // A PropertyChangeEvent has the following methods:
  // getPropertyName(), getNewValue(), getOldValue(), getSource()
  // From the SUN JDK API docs: Null values may be provided for 
  // the old and the new values if their true values are not known. 

  // Property names we're interested in:
  
  
  String FIELD_PROPERTY    = "schemeField";
  String VALUE_PROPERTY    = "schemeValue";
  String PROPERTY_PROPERTY = "property";
  
  // Other names directly correspond to the members of each scheme interface
}

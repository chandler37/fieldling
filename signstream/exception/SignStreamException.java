...
/*
 * SignStreamException.java
 *
 * Created on July 17, 2002, 6:31 PM
 */

package signstream.exception;

public class SignStreamException extends Exception {

    private Throwable sourceException;
  
    public SignStreamException(String msg) {
        super(msg);
    }
    
    public SignStreamException(String msg, Throwable throwable) {
      this(msg);

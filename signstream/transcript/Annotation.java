...
import signstream.io.ss2.SS2Value;

public class Annotation {
  public final int startTime, endTime;
  /** Will be either a SchemeValue or a String, depending on the type of track;
   Transitionally will be either SS2Value or String. */
  public final Object value;
  
  public Annotation(Object value, int startTime, int endTime) {
    if (!( value instanceof SS2Value || value instanceof String ))
      throw new IllegalArgumentException(
      "Only String or SchemeValue objects allowed for Annotations.");
    this.value = value;
  ...
  public String toString() {
    ...
    if (value instanceof SS2Value) 
      return " "+startTime+'-'+endTime+" "+((SS2Value)value).name+nl;
    else 
      return " "+startTime+'-'+endTime+"::"+(String)value+nl;
  }

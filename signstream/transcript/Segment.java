...
import signstream.gui.sequencer.SequencerModelListener;

/**
 *
 * @author  Jason Boyd
 */
public class Segment implements XMLNodeSerializable {
  ...
  public String toString() {
    ...
    buffer.append("Gloss excerpt: ");
    buffer.append(glossExcerpt+nl);
    for (int i=0, n=tracks.size(); i<n; i++) {
      buffer.append(tracks.elementAt(i).toString());
    }
    buffer.append(nl);

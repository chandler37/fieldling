...
public class I18n {            
	...
	public static ResourceBundle getResourceBundle() {
		...
		String default_interface_font = PreferenceManager.getValue(PreferenceManager.DEFAULT_INTERFACE_FONT_KEY, PreferenceManager.DEFAULT_INTERFACE_FONT_DEFAULT);

...
public class XMLRenderer {
	...
	private static final Color tagColor = Color.magenta;
	private static final Color attColor = Color.pink;
	private static final Color textColor = Color.darkGray;

    private XMLRenderer() {} //don't instantiate
    
    public static int render(Node node, JTextPane pane, int offset, float indent, XMLTagInfo tagInfo, Map startOffsets, Map endOffsets) {
    ...
    public static int renderElement(Element e, JTextPane pane, int offset, float indent, XMLTagInfo tagInfo, Map startOffsets, Map endOffsets) {
    ...
    public static int renderAttribute(Attr att, JTextPane pane, int offset, XMLTagInfo tagInfo, Map startOffsets, Map endOffsets) {
		StyledDocument doc = pane.getStyledDocument();
        try {
			Position pos = doc.createPosition(offset);
    ...
    public static int renderText(Text t, JTextPane pane, int offset, XMLTagInfo tagInfo, Map startOffsets, Map endOffsets) {
		StyledDocument doc = pane.getStyledDocument();
        try {
			Position pos = doc.createPosition(offset);

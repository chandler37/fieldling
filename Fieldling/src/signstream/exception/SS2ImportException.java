...
/*
 * SS2ImportException.java
 *
 * Created on July 17, 2002, 6:28 PM
 */

package signstream.exception;

public class SS2ImportException extends SignStreamException {
  public SS2ImportException(String msg) {
    super(msg);
  }
  
  public SS2ImportException(String msg, Throwable t) {
    super(msg, t);
  }
}

...
/*
 * SS2FileFormatException.java
 *
 * Created on July 17, 2002, 6:29 PM
 */

package signstream.exception;


public class SS2FileFormatException extends SS2ImportException {
  public SS2FileFormatException(String filename) {
    super (filename + "is not a valid SS2 DB file");
  }
  
  public SS2FileFormatException(String filename, int version) {
    super(filename + " is not in the most current DB format. Version "+
    "31 or later expected, "+ version + " found");
  }
}

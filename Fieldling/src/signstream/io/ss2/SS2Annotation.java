...
public final class SS2Annotation {
  public final int startTime, endTime;
  // this should only be public so long as SS2Value (and any other allowed
  // value objects) is immutable as well
  public final Object value;
  
  public SS2Annotation(Object value, int startTime, int endTime) {
    if (!( value instanceof SS2Value || value instanceof String ))
      throw new IllegalArgumentException(
      "Only String or SS2Value objects allowed for SS2Annotations.");
    this.value = value;
  ...
  public String toString() {
    if (value instanceof SS2Value) 
      return ""+startTime+'-'+endTime+"::#"+((SS2Value)value).id+"::";
    else 
      return ""+startTime+'-'+endTime+"::"+(String)value+"::";
  }
}

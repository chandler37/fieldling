 ...
 * TrackRenderer.java
 *
 * Created on January 8, 2003, 5:03 PM
 */
...
public interface TrackRenderer {
  ...
  // public Component getRendererComponent(Object data);
  
  int getHeight();
  Color getTrackLabelColor(SequencerTrack track);
  void paint(Graphics g, SequencerTrack track, 
    int startTime, int endTime, int pixPerSecond, 
    List selectedItems);
  
  String getTooltip(TrackItem item);
}

 ...
 * Scene.java
 *
 * Created on October 30, 2002, 2:04 PM
 */
...
/**
 Data:
     ...
     <>Duration
     <>Order of scenes
     <>Creation date (of SS3 scene)
 
 Operations:
      Get Assets for specified scene, time slice [, asset filter]
      Add file to scene
      [Remove file from scene] -- would allow user to move file?
...
public class Scene {
    ...
    Asset[] getAssets(int startTime, int endTime, Object assetFilter) {
      return new Asset[0];
    }
    String getName() { return null; }
    String setName() { return null; }
    private int calculateDuration() { return -1; }
    int getDuration() { return -1; }
    Date getAdditionDate() { return null; }
